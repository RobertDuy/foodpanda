<html>
    <head>
        ...
        <link href="<?php echo DIR_ROOT_NAME ?>/view/theme/default/stylesheet/detail2.css" rel="stylesheet">
        <link href="<?php echo DIR_ROOT_NAME ?>/view/theme/default/stylesheet/detail.css" rel="stylesheet">
        <link href="<?php echo DIR_ROOT_NAME ?>/view/theme/default/stylesheet/style.css" rel="stylesheet">
        <link href="<?php echo DIR_ROOT_NAME ?>/view/theme/default/stylesheet/dailydeal.css" rel="stylesheet">
                        ...
                        <div class="new_cart new_ajax_cart">
                            ...
                            <form id="cart-items-list-form" action="/cart/" method="post">
                                ...
                                <div>
                                    ...
                                    <p style="color:#00ac08; font-weight: bold; font-size: 14px; margin-top: 5px;">
                                ...
                                <table class="width_100" id="tableheader">
                                    ...
                                    <tr>
                                        ...
                                        <td class="width_15 center">Giá</td>
                                        <td class="width_10 center">Số lượng</td>
                                        <td class="width_20 right_align lastcolumn">Tổng cộng</td>
                                    </tr>
                                    </tbody>
                                </table>
                                <div class="scrollable">
                                    <table class="width_100 producttable">
                                        ...
                                        <tr>
                                            ...
                                            <td class="width_20 right_align price lastcolumn"> 799.000 VND
                                                <div style="color:green">- 39.950 VND</div></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div id="subtotal">
                                    <table class="width_100">
                                        ...
                                        <tr class="total">
                                            ...
                                            <td class="width_30 right_align lastcolumn"><div>759.050 VND</div>
                                                <div class="vatinclude">Đã bao gồm VAT</div></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
        ...
        <div class="page-wrapper js-sticky-height-calculate-container">
            <div class="content-wrapper">
                ...
                <main class="js-sticky-height-calculate-container">
                    ...
                    <input class="form-control twitter-typeahead tt-input" type="text" autocomplete="off" spellcheck="false" dir="auto" style="position: relative; vertical-align: top; background-color: transparent; width: 587px; " placeholder="Tìm kiếm theo sản phẩm, danh mục hay nhãn hàng bạn mong muốn"></span>
                                    ...
                                    <div class="total-cart-detail">
                                        <div class="header__cart headCart">
                                            ...
                                            <span class="header__cart__items num">1</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="banner-qc banner-qc-detail">
                        <div class="container">
             ...
             m_c"> </div>
                                    ...
                                    <div class="product-leadtime">
                                        ...
                                        <div class="product__promotion">
                                            <div class="product__promotion__item">
                                                <i class="icon-promotion1"></i> <span class="product__promotion__item__text">Giá tốt duy nhất trong ngày</span> </div>
                                            <div class="product__promotion__item">
                                                <i class="icon-promotion2"></i> <span class="product__promotion__item__text">Giao hàng toàn quốc</span> </div>
                                            <div class="product__promotion__item">
                                                <i class="icon-promotion3"></i> <span class="product__promotion__item__text">Đổi trả hàng miễn phí trong 30 ngày</span> </div>
                                        </div>
                                        <div class="fb-daily">
                ...
                <div class="menu-dailydeal">
                    <ul>
                        <li class="tab1">
                            <a href="">TẤT CẢ (2000 DEAL)</a>
                        </li>
                        <li>
                            <a href="">THỜi TRANG NAM</a>
                        </li>
                    </ul>
                </div><!--End-menu-dailydeal-->
                <div class="content-dailydeal">
                    <ul>
                        <li>
                            <a href="#"><img src="image/product.jpg"></a>
                            <span class="discount-min">-51%</span>
                            <div class="text-content">
                                <h4 class="title"><a href="">Tã quần merries L44</a></h4>
                                <div class="bottom-ct">
